...
public class transform_shear extends Frame {
  ...
  public void paint(Graphics g) {
    ...
    // Generate and draw a rectangle which will be sheared later on.
  ...
  public static void main(String[] argv) {
    int height = 300;
    transform_shear f = new transform_shear(height);
